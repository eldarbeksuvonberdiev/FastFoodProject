                            ...
                            <div class="card-body p-4">
                                <div class="row d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="col-md-3 col-lg-3 col-xl-3">
                                        <p class="lead fw-normal mb-2"><strong>Name: {{ $cartMeal['name'] }}</strong></p>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                        <h5 class="mb-0"><strong>Price: {{ $cartMeal['price'] }} So'm</strong></h5>
                                    </div>
                                    <div class="mr-5">
                                        <a href="#!" class="text-danger" style="font-size: 30px;"><i
